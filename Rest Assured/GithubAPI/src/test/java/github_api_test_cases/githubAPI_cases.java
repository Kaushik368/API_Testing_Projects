...
public class githubAPI_cases {
	public static String baseUrl="https://api.github.com";
	public static String owner;
	public static String repo_name;
	public static String token="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";
	JsonPath jsonpath;
